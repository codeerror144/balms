...
<head>
    ...
    <!-- DigitalPersona SDK JavaScript -->
    <script src="{{ asset('fingerprint.local/lib/jquery.min.js') }}"></script>
    <script src="{{ asset('fingerprint.local/lib/bootstrap.min.js') }}"></script>
    <script src="{{ asset('fingerprint.local/css/bootstrap.min.css') }}"></script>
    <script src="{{ asset('fingerprint.local/lib/ui-bootstrap-tpls-0.14.3.min.js') }}"></script>
    <script src="{{ asset('fingerprint.local/scripts/es6-shim.js') }}"></script>
    <script src="{{ asset('fingerprint.local/scripts/websdk.client.bundle.min.js') }}"></script>
    <script src="{{ asset('fingerprint.local/scripts/fingerprint.sdk.min.js') }}"></script>
    <script src="{{ asset('fingerprint.local/app.js') }}"></script>
    <script src="{{ asset('fingerprint.local/app.css') }}"></script>
                                ...
                                @if(!empty($notifications) && $notifications->count() > 0)
                                    @foreach($notifications as $notification)
                                        <a class="dropdown-item" href="{{ route('notification.show', $notification->id) }}">
                                            {{ $notification->title }} - {{ \Carbon\Carbon::parse($notification->created_at)->format('Y-m-d H:i:s') }}
                                        </a>
                                    @endforeach
                                @else
